...
var _sequence = [//scene2(0,1000)
];
var sequence = [//Screenshots
...
//Intro
sceneText(2, 1000, "mandarine"), sceneText(4, 1000, "presents"), effectBloomTo(0, .3, 100), setSpeed(0, .015), sceneSparks("sparks", 6, 13.5), setBgColor(0, C.Power, 1), //Scene1 Cube and Sparks
scene1("scene1", 0, 13.5), effectFlash(3, 3), setSpeed(6, .05), sceneCameraJump(5.3, 6), effectGlitch(5.8, 6.5), setBgColor(6, C.Background, 1), displayImage(6, 13.5), effectFlash(10, 5), effectUnPixalate(12, 13, 1), transition1("transition1", 13, 13.75, C.Power), //Scene2 WireOscilloscope
setSpeed(13.5, .020), effectBloomTo(13.5, 5, 500), setBgColor(13.5, "#000", 1), scene2("scene2", 13.5, 29), effectFlash(15, 5, 2000), effectFlash(20, 5, 2000), effectFlash(25, 5, 2000), transition2("transition2", 26.5, 29, C.Power), //Scene3 Cube and scrollText 3D
scene3("scene3", 29, 52), sceneScrollText(30, 52), setBgColor(29, "#000", 1), effectBloomTo(29, 4, 1000), effectFlash(32, 20), effectFlash(38, 20), effectFlash(43, 20), effectFlash(49, 20), effectPixalate(51, 1), effectGlitch(51.5, 52.5), //Scene4 Spaceship
scene4("scene4", 52, 68), effectBloomTo(52, .3, 1000), sceneSparks("sparks", 52, 68, C.Power), effectUnPixalate(55, 56, 1), effectGlitch(54, 55.5), effectGlitch(52, 2), effectGlitch(56, 2), effectGlitch(59, 10, 2000), sceneText(55, 2000, "code by med"), sceneText(60, 2000, "gfx by fra", "black"), sceneText(65, 2000, "music by med"), effectGlitch(67.1, 68.1), transition3("transition3", 67, 68.5, C.Power), //Scene5 Greets
setBgColor(68, "#000", 1), effectBloomTo(68.112, 3, 50), scene5("scene5", 68.112, 90), transition4("transition4", 88, 91, C.Power), //Scene6 Credits scroll screenshots and texts
